...
Uses the 26 STEP files generated by scripts/dev_tests/8.1_brep_generate.py as input.
...
Prerequisites:
  Run scripts/dev_tests/8.1_brep_generate.py first to generate STEP files in
...
# All 26 test shapes (matching scripts/dev_tests/8.1_brep_generate.py)
TEST_SHAPES = [
    # Surface types
    "plane_box",
    "cube",
...
if not os.path.isdir(STEP_DIR):
    ...
    print("       Run 'python scripts/dev_tests/8.1_brep_generate.py' first.")
    sys.exit(1)
...
if not available:
    print("ERROR: No STEP files found. Run 'python scripts/dev_tests/8.1_brep_generate.py' first.")
    sys.exit(1)
